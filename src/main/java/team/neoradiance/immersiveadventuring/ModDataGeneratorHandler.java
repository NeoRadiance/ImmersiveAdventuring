 ...
 * <ul>
 *   <li><strong>Item Tags</strong>: Generated by {@code NylonItemTags} for items like nylon ingots and plates</li>
 *   <li><strong>Block Tags</strong>: Generated by {@code NylonBlockTags} for blocks like nylon blocks</li>
...
public class ModDataGeneratorHandler
{
	...
	public static void gatherData(GatherDataEvent event)
	{
		...
		generator.addProvider(
				event.includeServer(),
				new ModItemTagsProvider(output, lookupProvider, modBlockTagsProvider.contentsGetter(), existingFileHelper)
		);
	}
}