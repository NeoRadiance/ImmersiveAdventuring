...
public class NylonTab {
    ...
    // Creates a creative tab with the id "immersiveadventuring:nylon_tab" for the nylon item, that is placed after the IE tab
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> NYLON_TAB = Register.CREATIVE_MODE_TABS.register("nylon_tab", () -> CreativeModeTab.builder()
            ...
            .withTabsBefore(ResourceLocation.fromNamespaceAndPath("immersiveengineering", "main"))
